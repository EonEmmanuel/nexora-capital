...
const userTransitionSources: Record<MockPaymentTransition, UserMockPaymentSourceStatus> = {
  DETECTED: 'PENDING',
  CONFIRMING: 'DETECTED',
  COMPLETED: 'CONFIRMING',
};
export function expectedUserMockPaymentSource(nextStatus: MockPaymentTransition) { return userTransitionSources[nextStatus]; }
